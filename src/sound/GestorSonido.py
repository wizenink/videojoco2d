...
class GeneralSoundManager():
	...
	def __init__(self, context):
		...
		#ambiente
		self.AMBIENTEAGUASPLASHS_SOUND		= pygame.mixer.Sound(CONTEXT+'res/sound/Ambiente/AmbienteAguaSplash.ogg'		)
		self.AMBIENTEANDARARENACORTO_SOUND	= pygame.mixer.Sound(CONTEXT+'res/sound/Ambiente/AmbienteAndarArenaCorto.ogg'	) 	
		self.AMBIENTEANDARRAMAS_SOUND		= pygame.mixer.Sound(CONTEXT+'res/sound/Ambiente/AmbienteAndarRamas.ogg'		) 	
		self.AMBIENTEBOSQUECORTO_SOUND		= pygame.mixer.Sound(CONTEXT+'res/sound/Ambiente/AmbienteBosqueCorto.ogg'		) 	
		self.AMBIENTECASCADA1_SOUND			= pygame.mixer.Sound(CONTEXT+'res/sound/Ambiente/AmbienteCascada1.ogg'			)	
		self.AMBIENTECASCADA2_SOUND			= pygame.mixer.Sound(CONTEXT+'res/sound/Ambiente/AmbienteCascada2.ogg'			) 	
		self.AMBIENTECASCOTESCAIDA_SOUND		= pygame.mixer.Sound(CONTEXT+'res/sound/Ambiente/AmbienteCascotesCaida.ogg'		) 	
		self.AMBIENTECOLISEO_SOUND			= pygame.mixer.Sound(CONTEXT+'res/sound/Ambiente/AmbienteColiseo.ogg' 			)
		self.AMBIENTEFUEGO1_SOUND			= pygame.mixer.Sound(CONTEXT+'res/sound/Ambiente/AmbienteFuego1.ogg'			)	
		self.AMBIENTEFUEGO2_SOUND			= pygame.mixer.Sound(CONTEXT+'res/sound/Ambiente/AmbienteFuego2.ogg'			)	 	
		self.AMBIENTEFUEGONOLOOP_SOUND		= pygame.mixer.Sound(CONTEXT+'res/sound/Ambiente/AmbienteFuegoNoLoop.ogg'		) 	
		self.AMBIENTEGENTEPANICO_SOUND		= pygame.mixer.Sound(CONTEXT+'res/sound/Ambiente/AmbienteGentePanico.ogg'		) 	
		self.AMBIENTEGENTEPANICOCORTO_SOUND	= pygame.mixer.Sound(CONTEXT+'res/sound/Ambiente/AmbienteGentePanicoCorto.ogg'	) 	
		self.AMBIENTEGENTESUSURROS_SOUND		= pygame.mixer.Sound(CONTEXT+'res/sound/Ambiente/AmbienteGenteSusurros.ogg'		) 	
		self.AMBIENTEGRANJA_SOUND			= pygame.mixer.Sound(CONTEXT+'res/sound/Ambiente/AmbienteGranja.ogg'			) 	
		self.AMBIENTEHOJASMANIPULAR_SOUND	= pygame.mixer.Sound(CONTEXT+'res/sound/Ambiente/AmbienteHojasManipular.ogg'	) 
		self.AMBIENTELLUVIA_SOUND			= pygame.mixer.Sound(CONTEXT+'res/sound/Ambiente/AmbienteLluvia.ogg'			) 	
		self.AMBIENTENOCHE_SOUND				= pygame.mixer.Sound(CONTEXT+'res/sound/Ambiente/AmbienteNoche.ogg'				) 	
		self.AMBIENTEPISARTIERRA_SOUND 		= pygame.mixer.Sound(CONTEXT+'res/sound/Ambiente/AmbientePisarTierra.ogg'		) 	
		self.AMBIENTERATA1_SOUND				= pygame.mixer.Sound(CONTEXT+'res/sound/Ambiente/AmbienteRata1.ogg'				) 	
		self.AMBIENTERATA2_SOUND				= pygame.mixer.Sound(CONTEXT+'res/sound/Ambiente/AmbienteRata2.ogg'				) 	
		self.AMBIENTERATA3_SOUND				= pygame.mixer.Sound(CONTEXT+'res/sound/Ambiente/AmbienteRata3.ogg'				) 	
		self.AMBIENTERATA4_SOUND				= pygame.mixer.Sound(CONTEXT+'res/sound/Ambiente/AmbienteRata4.ogg'				) 	
		self.AMBIENTERIO1_SOUND				= pygame.mixer.Sound(CONTEXT+'res/sound/Ambiente/AmbienteRio1.ogg'				) 	
		self.AMBIENTERIO2_SOUND				= pygame.mixer.Sound(CONTEXT+'res/sound/Ambiente/AmbienteRio2.ogg'				) 	
		self.AMBIENTEVIENTO_SOUND			= pygame.mixer.Sound(CONTEXT+'res/sound/Ambiente/AmbienteViento.ogg'			)


		#armas
		self.ARMADAGAIMPACTO_SOUND	 	= pygame.mixer.Sound(CONTEXT+'res/sound/Armas/ArmaDagaImpacto.ogg'		)	
		self.ARMAESPADAATAQUE1_SOUND		= pygame.mixer.Sound(CONTEXT+'res/sound/Armas/ArmaEspadaAtaque1.ogg'	)		
		self.ARMAESPADAATAQUE2_SOUND		= pygame.mixer.Sound(CONTEXT+'res/sound/Armas/ArmaEspadaAtaque2.ogg'	)		
		self.ARMAESPADAEQUIPAR_SOUND		= pygame.mixer.Sound(CONTEXT+'res/sound/Armas/ArmaEspadaEquipar.ogg'	)		
		self.ARMAESPADAIMPACTO_SOUND		= pygame.mixer.Sound(CONTEXT+'res/sound/Armas/ArmaEspadaImpacto.ogg'	)		
		self.ARMAFLECHAATAQUE1_SOUND		= pygame.mixer.Sound(CONTEXT+'res/sound/Armas/ArmaFlechaAtaque1.ogg'	)		
		self.ARMAFLECHAATAQUE2_SOUND		= pygame.mixer.Sound(CONTEXT+'res/sound/Armas/ArmaFlechaAtaque2.ogg'	)		
		self.ARMAFLECHAIMPACTO1_SOUND	= pygame.mixer.Sound(CONTEXT+'res/sound/Armas/ArmaFlechaImpacto1.ogg'	)	
		self.ARMAFLECHAIMPACTO2_SOUND	= pygame.mixer.Sound(CONTEXT+'res/sound/Armas/ArmaFlechaImpacto2.ogg'	)		
		self.ARMAHORCAATAQUE_SOUND		= pygame.mixer.Sound(CONTEXT+'res/sound/Armas/ArmaHorcaAtaque.ogg' 		)	
		self.ARMAHORCAIMPACTO_SOUND		= pygame.mixer.Sound(CONTEXT+'res/sound/Armas/ArmaHorcaImpacto.ogg' 	)	
		self.ARMAHORCAIMPACTO2_SOUND		= pygame.mixer.Sound(CONTEXT+'res/sound/Armas/ArmaHorcaImpacto2.ogg' 	)	
		self.ARMAMAGIAATAQUE_SOUND		= pygame.mixer.Sound(CONTEXT+'res/sound/Armas/ArmaMagiaAtaque.ogg' 		)	
		self.ARMAMANOTAZOIMPACTO_SOUND	= pygame.mixer.Sound(CONTEXT+'res/sound/Armas/ArmaManotazoImpacto.ogg' 	)	
		self.ARMAPUNHOIMPACTO_SOUND		= pygame.mixer.Sound(CONTEXT+'res/sound/Armas/ArmaPunhoImpacto.ogg' 	)	

		#menu
		self.CLICK_SOUND 		= pygame.mixer.Sound(CONTEXT+'res/sound/Menu/click.ogg'			)
		self.CLICK_2_SOUND		= pygame.mixer.Sound(CONTEXT+'res/sound/Menu/click_2.ogg'		) 	
		self.LOAD_SOUND			= pygame.mixer.Sound(CONTEXT+'res/sound/Menu/load.ogg'			)	
		self.MISC_MENU_SOUND		= pygame.mixer.Sound(CONTEXT+'res/sound/Menu/misc_menu.ogg'		)
		self.MISC_MENU_2_SOUND	= pygame.mixer.Sound(CONTEXT+'res/sound/Menu/misc_menu_2.ogg'	)	
		self.MISC_MENU_3_SOUND	= pygame.mixer.Sound(CONTEXT+'res/sound/Menu/misc_menu_3.ogg'	)	
		self.MISC_MENU_4_SOUND	= pygame.mixer.Sound(CONTEXT+'res/sound/Menu/misc_menu_4.ogg'	)	
		self.MISC_SOUND_SOUND	= pygame.mixer.Sound(CONTEXT+'res/sound/Menu/misc_sound.ogg'	)	
		self.NEGATIVE_SOUND		= pygame.mixer.Sound(CONTEXT+'res/sound/Menu/negative.ogg'		)
		self.NEGATIVE_2_SOUND	= pygame.mixer.Sound(CONTEXT+'res/sound/Menu/negative_2.ogg'	)	
		self.POSITIVE_SOUND		= pygame.mixer.Sound(CONTEXT+'res/sound/Menu/positive.ogg'		)
		self.SAVE_SOUND			= pygame.mixer.Sound(CONTEXT+'res/sound/Menu/save.ogg'			)
		self.SHARP_ECHO_SOUND	= pygame.mixer.Sound(CONTEXT+'res/sound/Menu/sharp_echo.ogg'	)

			
		#musica
		'''
		self.MUSICA1_SOUND = pygame.mixer.music.load(CONTEXT+'res/sound/Musica/Musica1.ogg')
		self.MUSICA2_SOUND = pygame.mixer.music.load(CONTEXT+'res/sound/Musica/Musica2.ogg')
		self.MUSICA3_SOUND = pygame.mixer.music.load(CONTEXT+'res/sound/Musica/Musica3.ogg')
		self.MUSICA4_SOUND = pygame.mixer.music.load(CONTEXT+'res/sound/Musica/Musica4.ogg')
		self.MUSICA5_SOUND = pygame.mixer.music.load(CONTEXT+'res/sound/Musica/Musica5.ogg')
		self.MUSICA6_SOUND = pygame.mixer.music.load(CONTEXT+'res/sound/Musica/Musica6.ogg')
		'''

		#personajes
		self.PERSONAJEGRITOSTANDARD_SOUND	= pygame.mixer.Sound(CONTEXT+'res/sound/Personajes/PersonajeGritoStandard.ogg'	) 	
		self.PERSONAJEVIDABAJA_SOUND			= pygame.mixer.Sound(CONTEXT+'res/sound/Personajes/PersonajeVidaBaja.ogg' 		)
		self.PERSONAJESGRITOHOMBRE_SOUND 	= pygame.mixer.Sound(CONTEXT+'res/sound/Personajes/PersonajesGritoHombre.ogg'	)	
		
	def generalSoundManage(self, event):


		if event < GAME_SOUND_EFFECT_EVENT: 
			self.effectManage(event, self.EFFECT_PRIORITY)
		elif event < GAME_SOUND_MUSIC_EVENT:
			self.musicManage(event, self.MUSIC_PRIORITY)
		elif event < GAME_SOUND_MENU_EVENT:
			self.menuManage(event, self.MENU_PRIORITY)
		else:
			print "evento desconocido"

			  
	def effectManage(self, event, priority):
	...
	def musicManage(self, event, priority):
	...
	def menuManage(self, event, priority):
...
def main2():
	...
	'''
	'''
	return GeneralSoundManager('/home/miguel/Descargas/videojoco2d-master/')
